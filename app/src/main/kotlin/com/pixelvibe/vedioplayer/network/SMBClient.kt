...
import com.hierynomus.mssmbj.messages.SMB2CreateResponseContext
...
class SMBClient(
    ...
    /**
     * Get an input stream for a remote file (for streaming to MPV).
     */
     ...
     */
    fun isConnected(): Boolean = connection?.isConnected == true && session?.isConnected == true
