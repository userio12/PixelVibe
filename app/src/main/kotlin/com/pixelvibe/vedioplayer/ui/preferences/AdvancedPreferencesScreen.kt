        ...
        Column(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f).padding(start = 16.dp)) {
                    Text("Edit mpv.conf", style = MaterialTheme.typography.bodyLarge)
                    Text("MPV configuration file", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
            ...
            Row(
                ...
                Icon(Icons.Default.Edit, contentDescription = null, tint = MaterialTheme.colorScheme.onSurface)
                Column(modifier = Modifier.weight(1f).padding(start = 16.dp)) {
                    Text("Edit input.conf", style = MaterialTheme.typography.bodyLarge)
            ...
            // Clear caches
            ClearCacheRow("Clear config cache", "Clear cached mpv.conf settings") { /* Clear */ }
