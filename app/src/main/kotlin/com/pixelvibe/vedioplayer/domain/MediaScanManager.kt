            ...
            val entries = filtered.mapNotNull { file ->
                when {
                    ...
                    MediaUtils.isVideoFile(file.name) -> {
                        val duration = MediaUtils.getVideoDuration(java.io.File("").absoluteContext ?: return@mapNotNull null, file.absolutePath)
                        val (width, height) = MediaUtils.getVideoDimensions(java.io.File("").absoluteContext ?: return@mapNotNull null, file.absolutePath)
